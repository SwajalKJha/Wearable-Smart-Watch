...
const int backlightPin = 4; // Backlight control pin (TFT_BL)
const int minBrightness = 10; // Adjust as needed
const int maxBrightness = 255; // Adjust as needed
...
void setup() {
    ...
    digitalWrite(backlightPin, TFT_BACKLIGHT_ON); // Turn on the backlight
