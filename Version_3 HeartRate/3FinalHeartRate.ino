...
#include "NotoSansBoldA.h"
#include "NotoSansBoldB.h"

#define FONT_SMALL NotoSansBoldA
#define FONT_LARGE NotoSansBoldB
...
switch (watchface) {
    ...
    case 3:
      ...
      break;
    case 4:
      drawHeartRate(beatAvg);
      break;
    default:
      drawAnalogClock(hh, mm, ss, dayOfWeek);
  }
}
void drawHeartRate(float beatAvg){
  ...
  if (checkForBeat(irValue) == true)                        //If a heart beat is detected
  {
    ...
    img.setCursor(80, 130);
    img.print(beatAvg);
    img.setCursor(120, 130);
    ...
    beatAvg = 0;
    img.loadFont(FONT_SMALL);
    img.setCursor(55, 120);
    img.setTextColor(TFT_CYAN, TFT_BLACK);
    img.fillSprite(TFT_BLACK);
    img.println("Please Place");
    img.setCursor(60, 140);
